...
#if defined(_MSC_VER)
#if defined(_MT) &&                                                            \
    defined(_DLL) // Corresponding to CL command line options /MD or /MDd.
#if (_MSC_VER) / 100 == 19
...
#endif
#elif defined(                                                                 \
    _LIBCPP_ABI_VERSION) // https://libcxx.llvm.org/DesignDocs/ABIVersioning.html
...
#error                                                                         \
    ...
    __GXX_ABI_VERSION >= 2000
#error                                                                         \
    "Unknown platform or compiler (__GXX_ABI_VERSION). Please revise this code."
#endif
#define NB_BUILD_ABI                                                           \
  "_libstdcpp_gxx_abi_1xxx_use_cxx11_abi_" NB_TOSTRING(_GLIBCXX_USE_CXX11_ABI)
#else
...
#define NB_PLATFORM_ABI_TAG NB_COMPILER_TYPE NB_BUILD_ABI NB_BUILD_TYPE
...
#define NB_ABI_TAG                                                             \
  "v" NB_TOSTRING(NB_INTERNALS_VERSION) NB_VERSION_DEV_STR                     \
      "_" NB_PLATFORM_ABI_TAG NB_STABLE_ABI NB_FREE_THREADED_ABI
