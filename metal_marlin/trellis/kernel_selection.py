...
def get_kernel_for_batch_size(
    ...
    Examples:
        ...
        >>> # Specialized decode kernel for GLM-4.7-Flash
        >>> get_kernel_for_batch_size(1, gate_bits=6, up_bits=2, down_bits=3)
    ...
    if batch_size <= thresholds["decode_max"]:
        ...
        if not use_fp32_acc and all(b is not None for b in (gate_bits, up_bits, down_bits)):
            ...
            if key in SPECIALIZED_DECODE_KERNELS:
                return SPECIALIZED_DECODE_KERNELS[key], TILE_SIZES["decode"]
